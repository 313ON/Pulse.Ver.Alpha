...
export type ActionRepositoryPort = { list(user?: SessionUser, context?: DashboardContext): unknown[]; get(publicId: string, user?: SessionUser): unknown; create(input: Record<string, unknown>): unknown; update(publicId: string, input: Record<string, unknown>): unknown };
export type KpiRepositoryPort = { list(context?: DashboardContext): unknown[]; get(id: string): unknown };
export type ProgramRepositoryPorts = { goals: GoalRepositoryPort; departmentalGoals?: DepartmentalGoalRepositoryPort; objectives: ObjectiveRepositoryPort; activities: ActivityRepositoryPort; actions: ActionRepositoryPort; kpis: KpiRepositoryPort };
